...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 52 52" }, props),
        React__default['default'].createElement("image", { width: "52", height: "52", href: "/images/logo.png" })));
};
...
var Icon$I = function (props) {
    return (React__default['default'].createElement("img", { src: "https://seeder.finance/images/partner/ic_farm.png", alt: "farm", width: "25px", style: { margin: "0 16px 0 4px" } })
    // <Svg viewBox="0 0 24 24" {...props}>
    //   <img src={"https://seeder.finance/images/partner/ic_farm.png"} alt="farm"  />
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 105 52" }, props),
        React__default['default'].createElement("image", { width: "105", height: "52", href: '/images/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        window.screen.width < 900 && React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
...
var LinkLabel = styled__default['default'].div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\ncolor: ", ";\n  transition: color 0.4s;\n  font-size:", ";\n  font-weight:", ";\n  flex-grow: 1;\n"], ["\ncolor: ", ";\n  transition: color 0.4s;\n  font-size:", ";\n  font-weight:", ";\n  flex-grow: 1;\n"])), function (_a) {
    ...
    return (isActive ? "#008000" : theme.colors.textSubtle);
}, function (_a) {
    var isActive = _a.isActive; _a.theme;
    return (isActive ? "23px" : "20px");
}, function (_a) {
    var isActive = _a.isActive; _a.theme;
    return (isActive ? 600 : 300);
});
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React__default['default'].createElement(LinkLabel, { isActive: entry.href === location.pathname, isPushed: isPushed }, entry.label))));
    })));
};
...
styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  display: flex;\n // background: red;\n  justify-content: space-between;\n  width: 100%;\n  padding: 10px"], ["\n  display: flex;\n // background: red;\n  justify-content: space-between;\n  width: 100%;\n  padding: 10px"])));
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            ...
            React__default['default'].createElement(Text, { color: "text", style: { textAlign: "center", fontSize: "15px" } }, "Where the safegains chatter"),
            React__default['default'].createElement("div", null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    {
                        social.items.map(function (item) {
                            return (React__default['default'].createElement("div", null,
                                React__default['default'].createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "text" }, item.label)));
                        });
                    }
                    // return (
...
var templateObject_1$C, templateObject_2$d, templateObject_3$8, templateObject_4$2, templateObject_5$1, templateObject_6, templateObject_7;

var StyledPanel = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  // top: ", ";\n  left: 0;\n  bottom:0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  // border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    // border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n  // box-shadow: 0 10px 30px 0px rgb(0 0 0 / 15%);\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  // top: ", ";\n  left: 0;\n  bottom:0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  // border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    // border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n  }\n  // box-shadow: 0 10px 30px 0px rgb(0 0 0 / 15%);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? "80px" : "80px");
}, window.screen.width > 900 ? "64px" : "0px", function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
}, function (_a) {
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "My wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { justifyContent: "center" },
            React__default['default'].createElement(Button, { as: "a", href: "https://bscscan.com/address/" + account, mr: "16px" }, "View on BscScan"),
            React__default['default'].createElement(Button, { variant: "secondary", onClick: function () {
                    logout();
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "secondary", style: { height: "42px" }, onClick: function () {
            onPresentAccountModal();
        } },
        React__default['default'].createElement("img", { src: "https://seeder.finance/images/ic_connected_wallet.svg", alt: "atm", style: { verticalAlign: "middle", display: "inline", marginRight: "8px" } }),
        accountEllipsis)) : (React__default['default'].createElement(Button, { size: "sm", variant: "primary", style: { height: "42px" }, onClick: function () {
            onPresentConnectModal();
        } },
        React__default['default'].createElement("img", { src: "https://seeder.finance/images/ic_wallet.svg", alt: "atm", style: { verticalAlign: "middle", display: "inline", marginRight: "8px" } }),
        " Connect to wallet"))));
};
...
var Menu = function (_a) {
    ...
    var _c = React.useState(true), isPushed = _c[0], setIsPushed = _c[1];
...
var templateObject_1$H, templateObject_2$g, templateObject_3$9, templateObject_4$3, templateObject_5$2;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F8F8F8", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#E0E0E0", tertiary: "rgba(156, 254, 143, 1)", text: "black", textDisabled: "#BDC2C4", textSubtle: "#000000", borderColor: "#f8d2d2", card: "	#F8F8F8", gradients: {
