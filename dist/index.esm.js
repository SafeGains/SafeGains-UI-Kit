...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 52 52" }, props),
        React.createElement("image", { width: "52", height: "52", href: "/images/logo.png" })));
};
...
var Icon$I = function (props) {
    return (React.createElement("img", { src: "https://seeder.finance/images/partner/ic_farm.png", alt: "farm", width: "25px", style: { margin: "0 16px 0 4px" } })
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 105 52" }, props),
        React.createElement("image", { width: "105", height: "52", href: '/images/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        window.screen.width < 900 && React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React.createElement(LinkLabel, { isActive: entry.href === location.pathname, isPushed: isPushed }, entry.label))));
    })));
};
...
styled.a(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            ...
            React.createElement(Text, { color: "text", style: { textAlign: "center", fontSize: "15px" } }, "Where the safegains chatter"),
            React.createElement("div", null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    {
                        social.items.map(function (item) {
                            return (React.createElement("div", null,
                                React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "text" }, item.label)));
                        });
                    }
                    // return (
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "My wallet", onDismiss: onDismiss },
        React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(CopyToClipboard, { toCopy: account }, "Copy Address")),
        React.createElement(Flex, { justifyContent: "center" },
            React.createElement(Button, { as: "a", href: "https://bscscan.com/address/" + account, mr: "16px" }, "View on BscScan"),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "secondary", style: { height: "42px" }, onClick: function () {
            onPresentAccountModal();
        } },
        React.createElement("img", { src: "https://seeder.finance/images/ic_connected_wallet.svg", alt: "atm", style: { verticalAlign: "middle", display: "inline", marginRight: "8px" } }),
        accountEllipsis)) : (React.createElement(Button, { size: "sm", variant: "primary", style: { height: "42px" }, onClick: function () {
            onPresentConnectModal();
        } },
        React.createElement("img", { src: "https://seeder.finance/images/ic_wallet.svg", alt: "atm", style: { verticalAlign: "middle", display: "inline", marginRight: "8px" } }),
        " Connect to wallet"))));
};
...
var Menu = function (_a) {
    ...
    var _c = useState(true), isPushed = _c[0], setIsPushed = _c[1];
